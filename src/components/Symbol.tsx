...
type SymbolProps = ComponentProps<"div">;

export const Symbol = ({ className, ...props }: SymbolProps) => (
  <div
    {...props}
    className={twMerge(
      "bg-[#008ffe] aspect-square w-1/3 h-auto flex items-center justify-center rounded-bl-3xl shadow-[#008ffe]/16 shadow-md",
